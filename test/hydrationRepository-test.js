...
describe('HydrationRepository', () => {
  ...
  it('Should be bale to return oz drinken over the course of 7 days', ()=> {
    expect(hydrationRepo.returnWeeksHydration(1, today)).to.deep.equal([{"2019/06/1": 20}, {"2019/06/2": 27}, {"2019/06/3": 37}, {"2019/06/4": 30}, {"2019/06/5": 50}, {"2019/06/6": 30}, {"2019/06/7": 32}]
)
  })
})
